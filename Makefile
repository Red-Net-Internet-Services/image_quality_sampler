...
package:		## Create new executable for windows systems
	...
	@poetry run pyinstaller --windowed --additional-hooks-dir hooks/ --name "AMS Capture - Quality Control Module" --windowed --add-data ".\image_quality_sampler\resources\;resources" --icon ".\image_quality_sampler\resources\qc.ico" .\image_quality_sampler\__main__.py 
	@echo "Application packaged. Check dist folder."

.PHONY: debug
debug:		## Create new executable for windows systems
	@echo "Packaging up application..."
	@poetry run pyinstaller --additional-hooks-dir hooks/ --name "AMS Capture - Quality Control Module" --add-data ".\image_quality_sampler\resources\;resources" --icon ".\image_quality_sampler\resources\qc.ico" .\image_quality_sampler\__main__.py 
	@echo "Application packaged. Check dist folder."